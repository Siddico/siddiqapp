...
# Title
st.title(" NLP App using 3 Hugging Face Models ")

# Instruction
st.write("Start with a short topic and let's work in three steps: Generate text about it ➔ Summarize ➔ Translate ")
